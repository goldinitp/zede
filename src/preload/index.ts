...
const api: ZedeApi = {
  ...
  prompts: {
    ...
    onChanged: (cb) => sub<null>('prompts:changed', () => cb())
  },
  internals: {
    ...
    onChanged: (cb) => sub<null>('internals:changed', () => cb())
  },
  settings: {
  ...
  ui: {
    ...
    onWindowResizing: (cb) => sub<boolean>('ui:windowResizing', cb),
    onClearTerminal: (cb) => sub<null>('ui:clearTerminal', () => cb()),
