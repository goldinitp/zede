...
// even though the source transcript still exists.
export class MemoryStore {
  ...
  /** Soft delete: tombstone + fingerprint + audit. Recoverable. */
  ...
  /**
   * Hard delete: purge the row + its sources/excerpts but KEEP the
