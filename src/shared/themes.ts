...
//
// Nerd Fonts v3 (2023) renamed every family: "MesloLGS NF" became
// "MesloLGS Nerd Font". Both spellings are listed so a v2- or v3-era install
// resolves — matching on the wrong one silently falls through to SF Mono,
// which has no glyphs above U+E000 and renders the whole prompt as tofu.
// Prefer the non-Mono family: the "… Nerd Font Mono" variants squeeze
// double-width powerline separators into one cell.
export const NERD_FONT_STACK =
  "'MesloLGS Nerd Font', 'MesloLGM Nerd Font', 'MesloLGL Nerd Font', 'MesloLGS NF', 'JetBrainsMono Nerd Font', 'FiraCode Nerd Font', 'Hack Nerd Font', 'Symbols Nerd Font', ui-monospace, 'SF Mono', SFMono-Regular, Menlo, monospace"

// Stacks persisted by earlier builds that named only v2 families. A stored
// value matching one of these is upgraded on read (see core.getSettings) —
// otherwise changing the constant above would only help fresh installs.
export const STALE_NERD_FONT_STACKS: readonly string[] = [
